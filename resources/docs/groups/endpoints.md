...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"repellendus","email":"eschmeler@example.org","password":"non","cnpj_emitente":"quaerat"}'
...
<p>
<b><code>cnpj_emitente</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
<input type="text" name="cnpj_emitente" data-endpoint="POSTapi-auth-register" data-component="body" required  hidden>
<br>
...
curl -X POST \
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"email":"yleuschke@example.org","password":"voluptatum"}'
...
```bash
curl -X GET \
    -G "http://localhost:8000/api/nfe/tempora" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
```javascript
const url = new URL(
    "http://localhost:8000/api/nfe/tempora"
);
...
```
<div id="execution-results-GETapi-nfe--chave-" hidden>
    <blockquote>Received response<span id="execution-response-status-GETapi-nfe--chave-"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-nfe--chave-"></code></pre>
</div>
<div id="execution-error-GETapi-nfe--chave-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-nfe--chave-"></code></pre>
</div>
<form id="form-GETapi-nfe--chave-" data-method="GET" data-path="api/nfe/{chave}" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('GETapi-nfe--chave-', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-GETapi-nfe--chave-" onclick="tryItOut('GETapi-nfe--chave-');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-GETapi-nfe--chave-" onclick="cancelTryOut('GETapi-nfe--chave-');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-GETapi-nfe--chave-" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-green">GET</small>
 <b><code>api/nfe/{chave}</code></b>
</p>
<h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
<p>
<b><code>chave</code></b>&nbsp;&nbsp;<small>string</small>  &nbsp;
<input type="text" name="chave" data-endpoint="GETapi-nfe--chave-" data-component="url" required  hidden>
<br>
...
```bash
curl -X POST \
    "http://localhost:8000/api/nfe/cancela" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json"
```
...
<div id="execution-results-POSTapi-nfe-cancela" hidden>
    <blockquote>Received response<span id="execution-response-status-POSTapi-nfe-cancela"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-nfe-cancela"></code></pre>
</div>
<div id="execution-error-POSTapi-nfe-cancela" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-nfe-cancela"></code></pre>
</div>
<form id="form-POSTapi-nfe-cancela" data-method="POST" data-path="api/nfe/cancela" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('POSTapi-nfe-cancela', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-POSTapi-nfe-cancela" onclick="tryItOut('POSTapi-nfe-cancela');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-POSTapi-nfe-cancela" onclick="cancelTryOut('POSTapi-nfe-cancela');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-POSTapi-nfe-cancela" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-black">POST</small>
 <b><code>api/nfe/cancela</code></b>
</p>
</form>
...
<div id="execution-results-POSTapi-nfe" hidden>
    <blockquote>Received response<span id="execution-response-status-POSTapi-nfe"></span>:</blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-nfe"></code></pre>
</div>
<div id="execution-error-POSTapi-nfe" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-nfe"></code></pre>
</div>
<form id="form-POSTapi-nfe" data-method="POST" data-path="api/nfe" data-authed="0" data-hasfiles="0" data-headers='{"Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('POSTapi-nfe', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
        <button type="button" style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-tryout-POSTapi-nfe" onclick="tryItOut('POSTapi-nfe');">Try it out ⚡</button>
    <button type="button" style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-canceltryout-POSTapi-nfe" onclick="cancelTryOut('POSTapi-nfe');" hidden>Cancel</button>&nbsp;&nbsp;
    <button type="submit" style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;" id="btn-executetryout-POSTapi-nfe" hidden>Send Request 💥</button>
    </h3>
<p>
<small class="badge badge-black">POST</small>
 <b><code>api/nfe</code></b>
</p>
</form>
